...
% Commands
\newcommand{\dia}[1]{\begin{figure}\centerline{\xymatrix{#1}}\end{figure}}
...
\begin{frame}
  ...
  \begin{example}
    \texttt{git checkout master \\ git merge SAVE-234}
  \end{example}
  \dia {
    *++[o][F-]{a} \ar[r] &
...
\begin{frame}
  ...
  \begin{example}
    \texttt{git checkout master \\ git merge --no-ff SAVE-234}
  \end{example}
  \dia {
    *++[o][F-]{a} \ar[r] &
    *++[o][F-]{b} \ar[r] \save +<0cm,0.6cm>*\txt{Master} \restore &
...
\begin{frame}
  \frametitle{Rebase}
  \begin{example}
    \texttt{git checkout SAVE-234 \\ git rebase master}
  \end{example}
  \dia {
    *++[o][F-]{a} \ar[r] &
    *++[o][F-]{b} \ar[r] \ar[rd] &
